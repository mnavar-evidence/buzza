...
- **ChatGPT App Manifest**: Hosted at `https://buzza.ai/.well-known/ai-plugin.json` describing OAuth, categories, and permissions for Buzza.
...
## Rollout Plan
1. **Sprint 1 - Foundation**: Ship mockable API endpoints, ChatGPT manifest, and landing page updates; recruit 10 beta merchants. *(Status: mock API+manifest live locally in `mock-api/`.)*
